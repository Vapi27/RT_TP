...
FOR %%x IN ("\Users\AdminEtu\Desktop\RT_TP\XAMPP\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Users\AdminEtu\Desktop\RT_TP\XAMPP\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Users\AdminEtu\Desktop\RT_TP\XAMPP\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Users\AdminEtu\Desktop\RT_TP\XAMPP\php\php.exe"
GOTO :INSTALLED
